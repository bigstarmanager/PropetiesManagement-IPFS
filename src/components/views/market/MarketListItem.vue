                    ...
                    <div class="h-full flex flex-col justify-between space-y-8">
                      <div class="flex flex-col space-y-8">
                        <div>
                          ...
                          <div class="mt-2 h-12 rounded-md shadow-sm flex">
                            <div 
                              ...
                              "
                            >
                              <div class="text-foam font-regular text-opacity-80">
                                ETH
                              </div>
                              <!-- <div>
                        ...
                        <div>
                          ...
                          <div class="mt-2 h-12 rounded-md shadow-sm flex">
                            ...
                            >
                              <div class="text-foam font-regular text-opacity-80 overflow-ellipsis overflow-hidden">
                                {{ asset.symbol }}
                              </div>
                            </div>
                            <input 
                      ...
                      <div>
                        <div class="mt-8 flex flex-col">
                          <button-example label="Swap" customClasses="w-full" @click="performSwap"/>
                        </div>
                      </div>
                    </div>
                  </div>
...
import ButtonExample from '../common/ButtonExample.vue'
